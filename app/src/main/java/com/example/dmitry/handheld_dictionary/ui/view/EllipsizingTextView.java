package com.example.dmitry.handheld_dictionary.ui.view;
...
public class EllipsizingTextView extends TypefaceTextView {
    ...
    /**
     * Adds {@link com.example.dmitry.handheld_dictionary.ui.view.EllipsizingTextView.EllipsizeListener} listener.
     *
     * @param listener The {@link com.example.dmitry.handheld_dictionary.ui.view.EllipsizingTextView.EllipsizeListener}.
     */
    ...
    public void setText(CharSequence text, TextView.BufferType type) {
        if (!programmaticChange) {
            ...
            /**
             * Editor Dmitry Nikitin on 11/14/2014.
    ...
    public interface EllipsizeListener {
        /**
         * Callback on ellipsize state changed.
         *
         * @param ellipsized True if ellipsized otherwise false.
         */
